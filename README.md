...
1. **知识库管理**: 上传和管理制度文件（支持批量上传、文档预览）
2. **文档上传**: 上传员工撰写的文档（支持批量上传、文档预览）
3. **智能对比**: 使用Ollama进行语义对比分析
4. **差异标注**: 自动识别并标注不符合项（支持查看、编辑、导出）
5. **结果展示**: 清晰的审查结果和统计信息（卡片式布局、AI改进建议）
6. **系统状态监控**: 实时检查Ollama服务和模型状态
7. **AI改进建议**: 智能生成详细的问题分析和修改建议
8. **标注导出**: 支持JSON、CSV格式和审查报告导出
...
**功能实现文档**：
- [高优先级功能实现说明](./高优先级功能实现说明.md) - 标注详情查看、编辑、审查详情等功能
- [中优先级功能实现说明](./中优先级功能实现说明.md) - 批量上传、标注导出、文档预览等功能
- [AI改进建议功能说明](./AI改进建议功能说明.md) - AI生成改进建议功能详解
